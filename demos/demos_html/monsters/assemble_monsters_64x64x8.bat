:: Takes a series of eighteen 64x128 frames, crops them to 64x64, then collects 
...
montage "%ImgName%0_crop.png" "%ImgName%1_crop.png" "%ImgName%2_crop.png" "%ImgName%3_crop.png" "%ImgName%4_crop.png" "%ImgName%5_crop.png" "%ImgName%6_crop.png" "%ImgName%7_crop.png" -background transparent -geometry 64x64! -tile 4x2 "sheets\%ImgName%_sheet.png"
