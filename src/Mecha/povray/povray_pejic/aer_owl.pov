...
// Date: Sun Aug 13 06:22:43 2006
// Input file: D:\Working\GearHead\Models\aer_owl.mpd
// ModelDir: D:\Working\GearHead\Models\
// LDRAWDIR: d:\Lego\LDraw
// Commandline: d:\Lego\L3P\L3P.exe D:\Working\GearHead\Models\aer_owl.mpd D:\Working\GearHead\POVRay -sw0 -q1 -o
...
#declare owlbombdoor_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_4213_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/80,0,SW/6,0>
		matrix <0,0,1,0,1,0,-1,0,0,0,-2,0>
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,0,-10,30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
...
#declare owltroop_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_970_dot_dat
...
#declare owlcontrolstick_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_4592_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,0.173648,-0.984808,0,0.984808,0.173648,0,-2,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
// 
}
...
#declare owlrocket_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_3957_dot_dat
	...
	object {
		_4589_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-92,0>
		#if (version >= 3.1) material #else texture #end { Color15 }
	}
	object {
		_4589_dot_dat
...
#declare owlagwingr_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_4459_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,-40,-18,-80>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3933_dot_dat
	...
	object {
		...
		matrix <0,0,-1,0,1,0,1,0,0,0,-10,-120>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-10,-2,-110>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-10,6,-110>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3794_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,10,-2,-110>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2540_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/36,0,SW/6,SW/-4.5>
		matrix <0,0,1,0,1,0,-1,0,0,10,6,-110>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3794_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,10,14,-120>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_6019_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,0,22,-110>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2555_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/18,0,0,0,1-SW/20,0,SW/-18,0>
		matrix <0,-1,0,1,0,0,0,0,1,36,8,-110>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0,-1,0,1,0,0,0,0,1,44,8,-110>
		#if (version >= 3.1) material #else texture #end { Color36 }
	}
	object {
		_2540_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/36,0,SW/6,SW/-4.5>
		matrix <0,0,-1,0,1,0,1,0,0,-10,-18,-180>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2540_dot_dat
	...
	object {
		_3933_dot_dat
		matrix <1-SW/78.71,0,0,0,1-SW/12,0,0,0,1-SW/160,SW/-122.031,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,-80,-2,-200>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3934_dot_dat
	...
	object {
		_2419_dot_dat
		matrix <1-SW/120,0,0,0,1-SW/12,0,0,0,1-SW/60,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,0,6,-190>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3794_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-10,-210>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-18,-210>
		#if (version >= 3.1) material #else texture #end { Color34 }
	}
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-26,50>
		#if (version >= 3.1) material #else texture #end { Color14 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		_3069bp09_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <-1,0,0,0,1,0,0,0,-1,0,-26,30>
		#if (version >= 3.1) material #else texture #end { Color14 }
	}
	object {
		_3069bp09_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,-30,-26,0>
		#if (version >= 3.1) material #else texture #end { Color14 }
	}
	object {
		_3069bp09_dot_dat
	...
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-30,-26,30>
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,0,-42,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2431_dot_dat
	...
	object {
		_4150_dot_dat
		matrix <1-SW/47.7803,0,0,0,1-SW/8,0,0,0,1-SW/47.7803,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-26,-160>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-26,-190>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object { owlrocket_dot_ldr matrix <0,0.707107,0.707107,-1,0,0,0,-0.707107,0.707107,-26,16,-140> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlrocket_dot_ldr matrix <0,0.707107,0.707107,-1,0,0,0,-0.707107,0.707107,-26,16,-80> #if (version >= 3.1) material #else texture #end { Color0 } }
// 
}

#declare owlagwingl_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_4459_dot_dat
...
#declare owlrearwing_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_3934_dot_dat
...
#declare owlwingr_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_3934_dot_dat
	...
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,-1,0,1,0,0,0,0,1,-38,10,90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,1,0,-1,0,0,0,0,1,58,10,90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
...
#declare owlwingl_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_3933_dot_dat
...
#declare owlantenna_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_2433_dot_dat
...
// ROTATION CONFIG 0 0
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,50,-48,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3040b_dot_dat
	...
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,0,1,0,-1,0,30,-38,-14>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
	...
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,0,1,0,-1,0,30,-38,-22>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4073_dot_dat
...
#declare owlhatch_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_4213_dot_dat
...
#declare owlpilottorso_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_970_dot_dat
	...
	object {
		_975_dot_dat
		matrix <1-SW/17.856,0,0,0,1-SW/31.363,0,0,0,1-SW/20.443,SW/-0.866628,SW/3.68868,SW/-5.88542>
		matrix <0,0,1,0.258819,0.965926,0,-0.965926,0.258819,0,0,-28,0>
		#if (version >= 3.1) material #else texture #end { Color2 }
	}
	object {
		_976_dot_dat
	...
	object {
		_977_dot_dat
		matrix <1-SW/25.52,0,0,0,1-SW/12,0,0,0,1-SW/12,SW/7.87654,SW/6,0>
		matrix <-0.866025,-0.5,0,-0.5,0.866025,0,0,0,-1,21,-12,-23>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_977_dot_dat
		matrix <1-SW/25.52,0,0,0,1-SW/12,0,0,0,1-SW/12,SW/7.87654,SW/6,0>
		matrix <-0.866025,-0.5,0,0,0,1,-0.5,0.866025,0,19,-9,19>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3626bp05_dot_dat
...
#declare owlpilot_dot_ldr = union {
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	object {
		_971_dot_dat
	...
	object { owlpilottorso_dot_ldr matrix <0.819152,-0.573576,0,0.573576,0.819152,0,0,0,1,-4,1,0> #if (version >= 3.1) material #else texture #end { Color2 } }
// 
}
...
#declare aer__owl_dot_mpd = union {
// FILE OWL.ldr
// WRITE "Owl" AG Transport Craft
// WRITE Name: Owl.mpd
...
// ROTATION CONFIG 0 0
	...
	object {
		_4032_dot_dat
		matrix <1-SW/47.7791,0,0,0,1-SW/12,0,0,0,1-SW/47.7791,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,220,-48,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4595_dot_dat
		matrix <1-SW/28,0,0,0,1-SW/22,0,0,0,1-SW/60,0,SW/3.14286,SW/-10>
		matrix <0,1,0,0,0,-1,-1,0,0,220,-30,20>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4595_dot_dat
	...
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,-1,0,1,0,0,0,0,1,256,-30,10>
		#if (version >= 3.1) material #else texture #end { Color36 }
	}
	object {
		_3062b_dot_dat
	...
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,0,1,0,-1,0,220,-30,-28>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		...
		matrix <-1,0,0,0,-1,0,0,0,1,220,-12,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3795_dot_dat
	...
	object {
		...
		matrix <0,0,-1,0,1,0,1,0,0,30,-48,-40>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3298_dot_dat
	...
	object {
		_3747_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/60,0,SW/2.8,SW/-3>
		matrix <1,0,0,0,1,0,0,0,1,100,-48,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3747_dot_dat
	...
	object {
		_3660_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <1,0,0,0,1,0,0,0,1,180,-48,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3660_dot_dat
	...
	object {
		_3660_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <1,0,0,0,1,0,0,0,1,220,-48,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3660_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,140,-56,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4162_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,50,-56,-70>
		#if (version >= 3.1) material #else texture #end { Color34 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_2432_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/32,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,100,-80,-90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2432_dot_dat
	...
	object {
		_2432_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/32,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,140,-80,-90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2432_dot_dat
	...
	object { owlbomb_dot_ldr matrix <0,1,0,-1,0,0,0,0,1,64,-38,-30> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,1,0,-1,0,0,0,0,1,64,-38,-10> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,1,0,-1,0,0,0,0,1,64,-38,10> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,1,0,-1,0,0,0,0,1,64,-38,30> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,-1,0,1,0,0,0,0,1,96,-38,30> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,-1,0,1,0,0,0,0,1,96,-38,10> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,-1,0,1,0,0,0,0,1,96,-38,-10> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbomb_dot_ldr matrix <0,-1,0,1,0,0,0,0,1,96,-38,-30> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlbombdoor_dot_ldr matrix <1,0,0,0,-1,0,0,0,-1,80,-18,0> #if (version >= 3.1) material #else texture #end { Color0 } }
	object {
		_3710_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,160,-24,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4477_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,0,1,0,1,0,-1,0,0,250,-80,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,1,0,-1,0,0,0,0,1,264,-70,-30>
		#if (version >= 3.1) material #else texture #end { Color46 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,270,-80,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3062b_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,0,1,0,1,0,-1,0,0,290,-80,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,1,0,-1,0,0,0,0,1,320,-70,-50>
	...
	object {
		_3957_dot_dat
		matrix <1-SW/16,0,0,0,1-SW/96,0,0,0,1-SW/16,0,SW/-2.4,0>
		matrix <0,-1,0,1,0,0,0,0,1,368,-70,-50>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_3957_dot_dat
	...
	object {
		...
		matrix <-1,0,0,0,-1,0,0,0,1,376,-70,-50>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_4274_dot_dat
	...
	object {
		_2357_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,SW/4,SW/2.8,SW/4>
		matrix <0,0,1,0,1,0,-1,0,0,10,-104,10>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3941_dot_dat
	...
	object {
		_3023_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,-70,-104,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4859_dot_dat
	...
	object {
		_4073_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-290,-104,10>
		#if (version >= 3.1) material #else texture #end { Color46 }
	}
	object {
		_4073_dot_dat
	...
	object {
		_4032_dot_dat
		matrix <1-SW/47.7791,0,0,0,1-SW/12,0,0,0,1-SW/47.7791,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-320,-104,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2654_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-320,-96,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2445_dot_dat
		matrix <1-SW/240,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-220,-112,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2540_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/36,0,SW/6,SW/-4.5>
		matrix <0,0,-1,0,1,0,1,0,0,-330,-120,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2540_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/36,0,SW/6,SW/-4.5>
		matrix <-1,0,0,0,1,0,0,0,-1,-300,-120,10>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2540_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,-250,-120,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3795_dot_dat
		matrix <1-SW/120,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,-160,-120,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4150_dot_dat
		matrix <1-SW/47.7803,0,0,0,1-SW/8,0,0,0,1-SW/47.7803,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,-320,-128,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,-290,-128,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4162_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,-90,-128,-10>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_3023_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,0,1,0,-1,0,-80,-118,-24>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3023_dot_dat
	...
	object {
		...
		matrix <-1,0,0,0,0,1,0,1,0,-80,-118,-32>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4276_dot_dat
	...
	object {
		_3040b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <0,1,0,0,0,1,1,0,0,-70,-118,-56>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3040b_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,0,1,0,-1,0,-70,-118,-64>
		#if (version >= 3.1) material #else texture #end { Color34 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_3749_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/16.9853,0,0,0,1-SW/16,0,0,0>
		matrix <0,0,-1,0,1,0,1,0,0,-40,-118,-40>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_3749_dot_dat
	...
	object {
		_3749_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/16.9853,0,0,0,1-SW/16,0,0,0>
		matrix <0,0,-1,0,1,0,1,0,0,0,-118,-40>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_3749_dot_dat
	...
	object {
		_3941_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,0>
		matrix <1,0,0,0,0,-1,0,1,0,-40,-118,-44>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3941_dot_dat
	...
	object {
		_3941_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,0>
		matrix <1,0,0,0,0,-1,0,1,0,0,-118,-44>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3941_dot_dat
	...
	object {
		_2654_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,0,-1,0,1,0,-40,-118,-68>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2654_dot_dat
	...
	object {
		_2654_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,0,-1,0,1,0,0,-118,-68>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2654_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,0,1,0,1,0,-1,0,0,30,-128,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,0,1,0,1,0,-1,0,0,30,-128,-10>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,1,0,-1,0,0,0,0,1,44,-118,-30>
		#if (version >= 3.1) material #else texture #end { Color46 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_3069bp68_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,1,-1,0,0,0,-1,0,44,-118,0>
		#if (version >= 3.1) material #else texture #end { Color15 }
	}
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,30,-104,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,0,1,0,-1,0,30,-94,-84>
		#if (version >= 3.1) material #else texture #end { Color46 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_3040b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <1,0,0,0,1,0,0,0,1,30,-128,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3040b_dot_dat
	...
	object { owltroop_dot_ldr matrix <1,0,0,0,1,0,0,0,1,72,-72,0> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owltroop_dot_ldr matrix <1,0,0,0,1,0,0,0,1,132,-72,0> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owltroop_dot_ldr matrix <0,0,-1,0,1,0,1,0,0,200,-72,48> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owltroop_dot_ldr matrix <0,0,1,0,1,0,-1,0,0,200,-72,-48> #if (version >= 3.1) material #else texture #end { Color0 } }
	object {
		_4864b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/52,0,0,0,1-SW/20,0,SW/2.36364,0>
	...
	object {
		_4864b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/52,0,0,0,1-SW/20,0,SW/2.36364,0>
		matrix <-1,0,0,0,1,0,0,0,-1,100,-128,-50>
		#if (version >= 3.1) material #else texture #end { Color33 }
	}
	object {
		_4864b_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,250,-104,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,0,1,0,-1,0,250,-94,-84>
		#if (version >= 3.1) material #else texture #end { Color46 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_4286_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/60,0,SW/2.8,SW/-3>
		matrix <0,0,1,0,1,0,-1,0,0,250,-104,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4286_dot_dat
	...
	object {
		_3710_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,250,-88,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4854_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/28,0,0,0,1-SW/80,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,300,-104,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <0,0,-1,0,1,0,1,0,0,250,-96,-10>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <1,0,0,0,1,0,0,0,1,250,-96,10>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2654_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,380,-80,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4871_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/80,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,360,-104,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4855_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/28,0,0,0,1-SW/80,0,SW/2.8,SW/-2.66667>
		matrix <0,0,1,0,1,0,-1,0,0,390,-104,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3795_dot_dat
		matrix <1-SW/120,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,340,-96,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4175_dot_dat
	...
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <0,0,-1,0,1,0,1,0,0,250,-112,30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3021_dot_dat
		matrix <1-SW/60,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,390,-104,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3794_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,370,-112,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3022_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,400,-112,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4859_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/60,0,SW/6,SW/6>
		matrix <0,0,1,0,1,0,-1,0,0,440,-112,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3023_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,380,-112,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3023_dot_dat
	...
	object {
		...
		matrix <1,0,0,0,1,0,0,0,1,340,-112,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2436_dot_dat
	...
	object {
		_3023_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,300,-112,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3023_dot_dat
	...
	object {
		_2432_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/32,0,0,0,1-SW/20,0,SW/2,0>
		matrix <-1,0,0,0,0,1,0,1,0,320,-102,-76>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2432_dot_dat
	...
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,0,1,0,-1,0,360,-102,-52>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,360,-120,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		_3024_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,390,-120,-30>
		#if (version >= 3.1) material #else texture #end { Color46 }
	}
	object {
		_3024_dot_dat
	...
	object {
		...
		matrix <0,0,-1,0,1,0,1,0,0,410,-136,0>
		#if (version >= 3.1) material #else texture #end { Color15 }
	}
	object {
		_4859_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/60,0,SW/6,SW/6>
		matrix <0,0,1,0,1,0,-1,0,0,440,-120,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3298_dot_dat
	...
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,250,-136,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3062b_dot_dat
	...
	object { owlcontrolstick_dot_ldr matrix <0.5,0,0.866025,0,1,0,-0.866025,0,0.5,370,-120,0> #if (version >= 3.1) material #else texture #end { Color0 } }
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,250,-160,-30>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3062b_dot_dat
	...
	object {
		_3941_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,0>
		matrix <1,0,0,0,1,0,0,0,1,-20,-152,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4150_dot_dat
		matrix <1-SW/47.7803,0,0,0,1-SW/8,0,0,0,1-SW/47.7803,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,-60,-160,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2419_dot_dat
		matrix <1-SW/120,0,0,0,1-SW/12,0,0,0,1-SW/60,0,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,-10,-160,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3033_dot_dat
	...
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <0,0,-1,0,1,0,1,0,0,50,-152,-90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2420_dot_dat
	...
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <-1,0,0,0,1,0,0,0,-1,150,-152,-90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <0,0,1,0,1,0,-1,0,0,150,-152,90>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <0,0,-1,0,1,0,1,0,0,150,-160,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2420_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,SW/4,SW/6,SW/4>
		matrix <1,0,0,0,1,0,0,0,1,150,-160,70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3710_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,220,-160,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3710_dot_dat
	...
	object {
		_3666_dot_dat
		matrix <1-SW/120,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,200,-160,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3666_dot_dat
	...
	object {
		_2654_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <1,0,0,0,1,0,0,0,1,140,-152,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4315_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/28,0,SW/6,SW/-7>
		matrix <0,0,1,0,1,0,-1,0,0,150,-160,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3623_dot_dat
	...
	object {
		_3623_dot_dat
		matrix <1-SW/60,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0,0,-1,0,1,0,1,0,0,150,-152,-150>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3623_dot_dat
	...
	object {
		...
		matrix <0,0,-1,0,1,0,1,0,0,50,-184,-100>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2744_dot_dat
	...
	object {
		_3040b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <1,0,0,0,1,0,0,0,1,70,-184,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3040b_dot_dat
	...
	object {
		_3040b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <1,0,0,0,1,0,0,0,1,130,-184,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3040b_dot_dat
	...
	object {
		_3039_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,SW/-4>
		matrix <-1,0,0,0,1,0,0,0,-1,140,-184,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3039_dot_dat
	...
	object {
		_3298_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/60,0,SW/2.8,SW/-3>
		matrix <0,0,1,0,1,0,-1,0,0,170,-184,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3298_dot_dat
	...
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,230,-168,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		_3069b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,250,-176,-60>
		#if (version >= 3.1) material #else texture #end { Color34 }
	}
	object {
		_3069b_dot_dat
	...
	object {
		_4315_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/12,0,0,0,1-SW/28,0,SW/6,SW/-7>
		matrix <0,0,1,0,1,0,-1,0,0,250,-176,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2431_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,250,-184,0>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4162_dot_dat
	...
	object {
		_4150_dot_dat
		matrix <1-SW/47.7803,0,0,0,1-SW/8,0,0,0,1-SW/47.7803,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,100,-168,-80>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4150_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,0,-1,0,1,0,1,0,0,30,-184,-70>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_4070_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0,0,-1,0,1,0,1,0,0,30,-184,-50>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4070_dot_dat
	...
	object {
		_2432_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/32,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,1,0,0,0,-1,0,-8,-174,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2432_dot_dat
	...
	object {
		_3068b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/40,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,40,-192,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3068b_dot_dat
	...
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,70,-192,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		_3068b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/40,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,160,-192,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_3068b_dot_dat
	...
	object {
		_2412a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0,0,-1,0,1,0,1,0,0,130,-192,-60>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_2412a_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,50,-192,-90>
		#if (version >= 3.1) material #else texture #end { Color34 }
	}
	object {
		_3070a_dot_dat
	...
	object {
		_3070a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <1,0,0,0,1,0,0,0,1,150,-192,-90>
		#if (version >= 3.1) material #else texture #end { Color34 }
	}
	object {
		_3070a_dot_dat
	...
	object { owlagwingr_dot_ldr matrix <1,0,0,0,0.92388,0.382683,0,-0.382683,0.92388,100,-174,-120> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlagwingl_dot_ldr matrix <-1,0,0,0,0.92388,-0.382683,0,-0.382683,-0.92388,100,-174,120> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlrearwing_dot_ldr matrix <0.707107,0.707107,0,0,0,1,0.707107,-0.707107,0,-435,-160.5,-4> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlwingr_dot_ldr matrix <1,0,0,0,0.965926,0.258819,0,-0.258819,0.965926,-308,-104.5,-119.5> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlwingl_dot_ldr matrix <-1,0,0,0,0.965926,-0.258819,0,-0.258819,-0.965926,-290,-104.5,119.5> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlantenna_dot_ldr matrix <0.707107,0,-0.707107,0.707107,0,0.707107,0,-1,0,-135,-118,-53.5> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlantenna_dot_ldr matrix <0.707107,0,0.707107,0.707107,0,-0.707107,0,1,0,-135,-118,53.5> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owldoor_dot_ldr matrix <1,0,0,0,1,0,0,0,1,180,-80,-70> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owldoor_dot_ldr matrix <-1,0,0,0,1,0,0,0,-1,180,-80,70> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlhatch_dot_ldr matrix <1,0,0,0,1,0,0,0,1,200,-160,0> #if (version >= 3.1) material #else texture #end { Color0 } }
	object { owlpilot_dot_ldr matrix <1,0,0,0,1,0,0,0,1,332,-112,0> #if (version >= 3.1) material #else texture #end { Color0 } }
	object {
		_2507_dot_dat
		matrix <1-SW/80,0,0,0,1-SW/56,0,0,0,1-SW/200,0,SW/2.33333,SW/-2.08333>
		matrix <0,0,1,0,1,0,-1,0,0,264,-172,0>
		#if (version >= 3.1) material #else texture #end { Color33 }
	}
// 
}
...
// From PARTS: 111
// Frame Level Objects: 36808
// Frame Level Objects: 10184 (QUAL<3)
// stud.dat: 1024
// BoundingBox: <-522.604,-245.353,-358.143> <460,-4,358.143>
// Center: <-31.3018,-124.676,0>
// Size: <982.604,241.353,716.286>
