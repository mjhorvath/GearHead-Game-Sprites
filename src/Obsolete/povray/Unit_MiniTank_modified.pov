...
#declare ACP_Texture = texture {Main_Texture};
#declare ACP_Texture_Secondary = texture {Highlight_Texture};
#declare Wheel_Texture = texture {pigment {colour <.10,.10,.10>} finish {Default_Finish}}

//***************Camera&lights&some other nuisances************************
...
/*
camera {
    location  <0.0, 23, -80.0> //8 m. afar
    direction 1.5*z
    right     4/3*x
    look_at   <0.0, 8,  0.0>
}*/
/* EDIT
//To get a nice isometric view we should place the camera as
//Twice as far as hight.
camera {
    location  <0.0, 44, -80.0> //8 m. afar
    direction 1.5*z
    right     2/1*x
    look_at   <0.0, 8,  0.0>
    orthographic
