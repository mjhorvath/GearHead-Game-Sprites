...
object{ AxisXYZ( 5.00, 0, 5.00, Texture_A_Dark, Texture_A_Light)}
...
#macro Populate_Hyperbola(PopObject, MaxCount)
	union
	{
		#local Count = 0;
		#local MaxCount = Trees_Number;
...
Populate_Hyperbola(TREE, Trees_Number)