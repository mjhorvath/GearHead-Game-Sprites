...
#declare Max_Storeys = 2;		// roughly, the maximum height of a building, in storeys (actual values are random, and are slightly greater or less than this). (note: a size-1 hill is 32 units tall.)
...
#declare Block_Size = 2;		// the number of buildings per block.
...
#declare Rotate_Y = clock * 1440 + 360;	// rotate the object around the Y-axis by this amount.
#declare City_Seed = 23424;		// seed for random city generator.
