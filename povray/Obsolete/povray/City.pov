...
#declare Scale_Factor = 1;		// the scene is scaled down by this factor.
...
#declare City_Seed = 0110999;		// seed for random city generator.
...
// CREATE CITY AND SAVE TO FILE
   ...
   #declare city_transform = transform {rotate y * 180 scale Scale_Factor scale y * Width / Building_Width rotate y * Rotate_Y}
